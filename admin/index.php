...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=advertisement">
                    <i class="fas fa-ad"></i>
                    ...
                    <?php
                        if(isset($_GET['page'])) {
                            switch ($_GET['page']) {
                                ...
                                //========================================
                                case 'advertisement':
                                    include './adver/read.php';
                                    break;
                                case 'add-advertisement':
                                    include './adver/create.php';
                                    break;
                                case 'update-advertisement':
                                    include './adver/update.php';
                                    break;
                                //========================================
                                case 'news':
                                    include './news/read.php';
                                    break;
                                case 'add-news':
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Developed by <a href="">Hoang Huy</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
